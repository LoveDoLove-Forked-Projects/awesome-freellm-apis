<p align="center">
  ...
  <!-- AUTO_STATS -->
  <p align="center"><strong>31プロバイダー、450+の無料LLM API</strong> — 無料モデルを検索・比較・設定。</p>
<!-- END_AUTO_STATS -->
</p>
...
<p align="center">
  ...
  <!-- AUTO_UPDATE_BADGE -->
  <p align="center"><strong>🔄 <a href="https://freellm.net" target="_blank" rel="noopener">freellm.net</a> から毎日自動更新</strong> — 最終更新: 2026-08-23</p>
...
- [3ステップで始める](#3ステップで始める)
- [プロバイダーディレクトリと人気の無料モデル](#プロバイダーディレクトリ--人気の無料モデル)
- [クイックリファレンス](#クイックリファレンス--base-url-と-apiキー)
- [プロバイダー別ベスト無料モデル](#プロバイダー別ベスト無料モデル)
